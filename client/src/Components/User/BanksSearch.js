...
const BanksSearch = (props) => {
    ...
    useEffect(() => {
        axios.post(`${API_URL}/bank/user`, props, { withCredentials: true })
            ...
            <table className='border w-full text-center'>
                ...
                <tbody className="p-3">
                    {data.length ? 
                                ...
                                <td className="py-2 px-4 border">
                                    <div className='flex justify-between items-center'>
                                        ...
                                        <div className='flex items-center'>
                                            &nbsp;&nbsp;
                                            <i className="fa-solid fa-circle-info fa-lg" onClick={() => setPopup(i)}></i>
                                            &nbsp;&nbsp;&nbsp;
                                            {selected === i ? <i className="fa-regular fa-circle-check fa-lg"></i> : <i className="fa-regular fa-circle fa-lg"></i>}
                                        </div>
                                    </div>
                                </td>
                            </tr>
                        ...
                        : 
                        <tr>
                            <td colSpan={4} className='text-center text-md font-bold my-6'>No Data Found</td>
                        </tr>
                    }
                </tbody>
            </table>
